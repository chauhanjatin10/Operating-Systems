...
FILE* log_file = fopen("FairRW-log.txt", "w");
...
double worst_writer_time = double(INT_MIN);
double worst_reader_time = double(INT_MIN);
...
int main(){
    ...
    fclose(log_file);
    log_file = fopen("Average_time_FairRW.txt","w");
